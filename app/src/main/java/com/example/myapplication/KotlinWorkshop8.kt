...
open class Person(phoneCode: String) {
...
fun <E> MutableList<E>.replacePlacesWithThePhoneCode(p: Person, placeNum: Int = 3) {
    this.mapIndexed { index, any -> if (index % placeNum == 0) p.code else any }
}
